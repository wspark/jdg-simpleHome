...
public class BBSManageDAO extends EgovAbstractDAO {
	...
	Logger log = LoggerFactory.getLogger(BBSManageDAO.class);
     ...
     * @throws Exception
     */
    @Cacheable(value = "sqlcache", key = "#boardVO.bbsId.concat(#boardVO.nttId)")
    public BoardVO selectBoardArticle(BoardVO boardVO) throws Exception {
    	
    	log.info("===========================");
    	log.info("selectBoardArticle called!!");
    	log.info("===========================");
     ...
     * @throws Exception
     */
    @CacheEvict(value = "sqlcache", allEntries = true)
    public void updateBoardArticle(Board board) throws Exception {
    	
    	log.info("===========================");
    	log.info("updateBoardArticle called!!");
    	log.info("===========================");
